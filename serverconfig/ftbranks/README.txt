...
Last README file update: Sat Aug 23 00:27:19 CEST 2025
...
command.events.force.ftb:allay
command.events.force.ftb:allay.target
command.events.force.ftb:allay.target.options
command.events.force.ftb:allay.target.viewername
command.events.force.ftb:allay.target.viewername.options
command.events.force.ftb:apoth_boss
command.events.force.ftb:apoth_boss.target
command.events.force.ftb:apoth_boss.target.options
command.events.force.ftb:apoth_boss.target.viewername
command.events.force.ftb:apoth_boss.target.viewername.options
...
command.events.force.ftb:fairy
command.events.force.ftb:fairy.target
command.events.force.ftb:fairy.target.options
command.events.force.ftb:fairy.target.viewername
command.events.force.ftb:fairy.target.viewername.options
command.events.force.ftb:frogs
command.events.force.ftb:frogs.target
command.events.force.ftb:frogs.target.options
command.events.force.ftb:frogs.target.viewername
command.events.force.ftb:frogs.target.viewername.options
...
command.events.force.ftb:llama
command.events.force.ftb:llama.target
command.events.force.ftb:llama.target.options
command.events.force.ftb:llama.target.viewername
command.events.force.ftb:llama.target.viewername.options
command.events.force.ftb:phantom
command.events.force.ftb:phantom.target
command.events.force.ftb:phantom.target.options
command.events.force.ftb:phantom.target.viewername
command.events.force.ftb:phantom.target.viewername.options
command.events.force.ftb:pyromancer
command.events.force.ftb:pyromancer.target
command.events.force.ftb:pyromancer.target.options
command.events.force.ftb:pyromancer.target.viewername
command.events.force.ftb:pyromancer.target.viewername.options
...
command.events.toggle.ftb:allay
command.events.toggle.ftb:apoth_boss
command.events.toggle.ftb:creeper
command.events.toggle.ftb:fairy
command.events.toggle.ftb:frogs
command.events.toggle.ftb:goat
command.events.toggle.ftb:llama
command.events.toggle.ftb:phantom
command.events.toggle.ftb:pyromancer
...
command.gamerule
command.gamerule.allowHooksWhileFlying
command.gamerule.allowHooksWhileFlying.value
